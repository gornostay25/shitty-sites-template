...
**Architecture:** Monolith native plugin `bol-theme` owns design tokens, header/footer/mobile chrome, five PT block types, venue KV settings + React `/venue` admin, and `page:metadata` JSON-LD. Home page is a CMS `pages` entry composed of PT blocks.
...
| **2** | [02-plugin-core.md](./2026-09-05-bol-theme-migration-02-plugin-core.md) | 4–8 | `bol-theme` scaffold, venue KV, JSON-LD, admin, UI i18n |
