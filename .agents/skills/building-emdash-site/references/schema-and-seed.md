...
```bash
bunx emdash export-seed                      # Schema only
bunx emdash export-seed --with-content       # Schema + all content
bunx emdash export-seed --with-content=posts,pages  # Specific collections
```
