...
```bash
bunx emdash content get posts 01ABC123 --raw
```
...
bunx emdash content create posts --data '{"title": "Hello", "body": "# Welcome\n\nThis is **bold**."}'

# Raw PT array — passed through as-is
bunx emdash content create posts --data '{"title": "Hello", "body": [{"_type": "block", "children": [{"_type": "span", "text": "Welcome"}]}]}'
```
...
bunx emdash content update posts 01ABC123 \
