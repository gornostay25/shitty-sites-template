...
**Trusted plugins only.** PT blocks require Astro components for site-side rendering (`componentsEntry`), loaded at build time from an bun package. Sandboxed/marketplace plugins cannot define PT blocks.
